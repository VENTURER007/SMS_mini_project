...
<aside class="sidebar position-fixed top-0 left-0 overflow-auto h-100 float-left" id="show-side-navigation1">
  ...
  <ul class="categories list-unstyled">
    ...
    <li class="">
      <i class="uil-user"></i><button class="button" onclick="personal_details();" id="personal_details" href="#"> Personal Details</button>
      <script> personal_details()</script> </script>
      <ul class="sidebar-dropdown list-unstyled">
       
      </ul>
    </li>
    <li class="">
      <i class="uil-book-alt"></i><a href="#">Academic Details</a>
      <ul class="sidebar-dropdown list-unstyled">
      ...
      <div class="collapse navbar-collapse" id="toggle-navbar">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            ...
            <a class="nav-link" href="#"><i class="uil-sign-out-alt"></i></a>
