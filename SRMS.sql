...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3474631530ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=SRMS&table=users">`SRMS`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=SRMS&table=results_table">`SRMS`.`results_table`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=SRMS&table=exam_table">`SRMS`.`exam_table`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=SRMS&table=ce_marks">`SRMS`.`ce_marks`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=SRMS&table=subject_table">`SRMS`.`subject_table`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=SRMS&table=result_subject_table">`SRMS`.`result_subject_table`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=SRMS&table=images">`SRMS`.`images`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=students_portal&table=has_degree">`students_portal`.`has_degree`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=students_portal&table=degree">`students_portal`.`degree`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=students_portal&table=contact">`students_portal`.`contact`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="317c31372e5036454f2c447d623b2739">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="SRMS" targettable="users">
