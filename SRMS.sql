...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2543978954ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=SRMS&table=users">`SRMS`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=SRMS&table=ce_marks">`SRMS`.`ce_marks`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=SRMS&table=results_table">`SRMS`.`results_table`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=SRMS&table=exam_table">`SRMS`.`exam_table`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=project&table=User_details">`project`.`User_details`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=project&table=App">`project`.`App`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=project&table=App_interest">`project`.`App_interest`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=project&table=Web_interest">`project`.`Web_interest`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=project&table=Web">`project`.`Web`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=project&table=Wating_list">`project`.`Wating_list`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2775286e505d65322a7c2a4d3c776057">
